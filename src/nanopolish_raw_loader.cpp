...
*/
        ...
        for(int offset = min_offset; offset < max_offset; ++offset) {
            ...
            fixed f_lp_step = lp_step;
            fixed f_lp_stay = lp_stay;
            fixed f_lp_skip = lp_skip;
    ...
    */
    ...
    std::ofstream myfile;
    myfile.open("similar_flag_fix_18_14_30.txt", std::fstream::app);
